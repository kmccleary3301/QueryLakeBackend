'''
This file was copied from this PR: 
https://github.com/oobabooga/text-generation-webui/pull/4953
which was in turn 100% copied from this PR to the Transformers library:
