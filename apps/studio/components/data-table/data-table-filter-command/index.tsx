...
export interface DataTableFilterCommandProps<TData, TSchema extends z.AnyZodObject> {
  table: Table<TData>;
  schema: TSchema;
...
export function DataTableFilterCommand<TData, TSchema extends z.AnyZodObject>({
  ...
  const [commandPrefixRecentlyTyped, setCommandPrefixRecentlyTyped] = useState<boolean>(false);
