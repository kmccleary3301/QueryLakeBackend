...
>(({ leading, trailing, containerClassName, className, ...props }, ref) => {
  return (
    <div id="input_with_addons" className={cn("border-input ring-offset-background focus-within:ring-ring group flex h-10 w-full rounded-md border bg-transparent text-sm focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 overflow-hidden", containerClassName)}>
      {leading ? (
