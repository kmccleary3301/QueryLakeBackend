...
const Sidebar = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
    ...
    collapsible?: "offcanvas" | "icon" | "none" | "motion"
  }
>(
  (
    {
    ...
    React.useEffect(() => {
      console.log("state", state, collapsible);
    ...
    if (collapsible === "motion") {
      return (
        <motion.div 
          className="h-full bg-background-sidebar flex flex-col p-0 z-54" 
          initial={{width: (state === "expanded")?0:"320px"}} 
          animate={controlsSidebarWidth} 
        >
          <div
            className={cn(
